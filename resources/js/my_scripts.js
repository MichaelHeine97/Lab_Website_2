...
function loadStatsPage(){
	...
	for(row=2; row<table.rows.length; row++){
		CUScore=table.rows[row].cells[2].innerHTML;
		OppScore=table.rows[row].cells[3].innerHTML;
		if (CUScore > OppScore){
	...
	document.getElementById("wins").innerHTML=parseInt(wins1);
	document.getElementById("losses").innerHTML=parseInt(losses1);
}
/*
